...
import me.furansa.desconstruindo.bugtracker.controllers.TicketController;
...
public class TicketControllerUnitTest {
    private final String url = "/api/v1/tickets/";
    ...
    public void getOne() throws Exception {
        ...
        // Verify the output against the repository
        verify(ticketRepository, times(1)).getOne(id);
    }
